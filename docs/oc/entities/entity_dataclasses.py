...
@dataclass
class ValidationCheckAgentValidator:
    """Source: vendor/OpenAgentsControl/.opencode/plugin/agent-validator.ts"""
    data: Any = None

@dataclass
class ValidationResultAgentValidator:
    """Source: vendor/OpenAgentsControl/.opencode/plugin/agent-validator.ts"""
    data: Any = None

@dataclass
class SubtaskTaskCli:
    """Source: vendor/OpenAgentsControl/.opencode/scripts/task-cli.ts"""
    id: Any = None
    seq: Any = None
    title: Any = None
    status: Any = None
...
class TaskTaskCli:
    ...
    objective: Any = None
    context_files: Any = None
    exit_criteria: Any = None
    subtask_count: Any = None
    completed_count: Any = None
    created_at: Any = None
    completed_at: Any = None

@dataclass
class SubtaskTaskCli2:
    """Source: vendor/OpenAgentsControl/.opencode/skill/task-management/scripts/task-cli.ts"""
    id: Any = None
    seq: Any = None
    title: Any = None
    status: Any = None
    ...
    parallel: Any = None
    context_files: Any = None
    reference_files: Any = None
    acceptance_criteria: Any = None
    deliverables: Any = None
    agent_id: Any = None
    suggested_agent: Any = None
    started_at: Any = None
    completed_at: Any = None
    completion_summary: Any = None
...
@dataclass
class EnvLoaderConfigIndex:
    """Source: vendor/OpenAgentsControl/.opencode/tool/env/index.ts"""
    data: Any = None

@dataclass
class ImageConfigIndex:
    """Source: vendor/OpenAgentsControl/.opencode/tool/gemini/index.ts"""
    outputDir: Any = None
    useTimestamp: Any = None
    preserveOriginal: Any = None
    customName: Any = None
