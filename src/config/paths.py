...
OUT_I_CALC_TI_DIR: Path = OUT_I_CALC_DIR / "TI"
OUT_I_CALC_PP_DIR: Path = OUT_I_CALC_DIR / "PP"
OUT_I_CALC_ML_DIR: Path = OUT_I_CALC_DIR / "ML"
OUT_I_CALC_ML_VG_DB_PATH: Path = OUT_I_CALC_ML_DIR / "ML_VG_tables.sqlite"
OUT_I_CALC_LLM_DIR: Path = OUT_I_CALC_DIR / "LLM"
OUT_I_CALC_LLM_VG_DB_PATH: Path = OUT_I_CALC_LLM_DIR / "LLM_VG_tables.sqlite"
OUT_I_CALC_MARKERS_DB_PATH: Path = OUT_I_CALC_DIR / "Markers.sqlite"
...
PATHS = {
    ...
    "OUT_I_CALC_TI_DIR": OUT_I_CALC_TI_DIR,
    "OUT_I_CALC_PP_DIR": OUT_I_CALC_PP_DIR,
    "OUT_I_CALC_ML_DIR": OUT_I_CALC_ML_DIR,
    "OUT_I_CALC_ML_VG_DB_PATH": OUT_I_CALC_ML_VG_DB_PATH,
    "OUT_I_CALC_LLM_DIR": OUT_I_CALC_LLM_DIR,
    "OUT_I_CALC_LLM_VG_DB_PATH": OUT_I_CALC_LLM_VG_DB_PATH,
    "OUT_I_CALC_MARKERS_DB_PATH": OUT_I_CALC_MARKERS_DB_PATH,
...
__all__ = [
    ...
    "OUT_I_CALC_PP_DIR",
    "OUT_I_CALC_ML_DIR",
    "OUT_I_CALC_ML_VG_DB_PATH",
    "OUT_I_CALC_LLM_DIR",
    "OUT_I_CALC_LLM_VG_DB_PATH",
    "OUT_I_CALC_MARKERS_DB_PATH",
    "OUT_I_CALC_SVL_DIR",
    "OUT_I_CALC_TDA_DIR",
    "OUT_I_CALC_FH3_DIR",
    "OUT_I_CALC_FOLLOWUP_ML_DIR",
